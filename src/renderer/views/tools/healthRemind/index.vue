<template>
  <div class="tools-container">
    ...
    <div class="set-healthRemind">
      <div class="topLine">
        健康提醒<el-switch v-model="healthRemindSwitch" style="margin-left:16px"/>
      </div>
      <div class="midLine">
        间隔时间
        <el-input-number 
    ...
    <div class="set-voice">
      ...
      <div class="midLine">
        自定义提示话术<el-input v-model="inputWord" style="width:500px;margin-left:16px" @change="wordChange" />
